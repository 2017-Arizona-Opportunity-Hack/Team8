  ...
  render() {
    ...
    return (
      ...
      <div className="card card-container spacer">
        ...
        <img id="profile-img" alt="profile" className="profile-img" src="../images/logo.png"/>
        ...
        <form onSubmit={this.props.handleSubmit(this.handleLogin)} className="form-signin">
          ...
          <Field id="inputPassword" name="password" type="password" component={renderField} label="password"/> {error && <strong>{error}</strong>}
          <br/>
